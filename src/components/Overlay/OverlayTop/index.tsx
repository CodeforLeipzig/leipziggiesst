    ...
    <StyledTop>
      <Wrapper>
        ...
        {!isMobile && (<div style={{ width: '60%', fontSize: '16pt', fontStyle: 'bold', color: 'blue' }}>
          Kommender Termin: Baum-Rallye, Quizzen und Gießen <a href="/event/20240622_giessen_bei_lene">diesen Samstag, am 22.6., 11:00, im Lene-Voigt-Park</a><br /><br />Alle Gießevents findet ihr ab sofort <a href="/events">links in der Seitenleiste</a> und auf der Karte.
        </div>)}
      </Wrapper>
