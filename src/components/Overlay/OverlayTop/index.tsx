    ...
    <StyledTop>
      <Wrapper>
        ...
        {!isMobile && (<div style={{ width: '60%', fontSize: '16pt', fontStyle: 'bold', color: 'blue' }}>
          Kommender Termin: Besucht uns am Sonntag, den 26.5., an unserem <a href="/event/20240526_grassi_jubilaeum">Stand beim Grassi-Jubiläum.</a><br /><br />Alle Gießevents findet ihr ab sofort <a href="/events">links in der Seitenleiste</a> und auf der Karte.
        </div>)}
      </Wrapper>
