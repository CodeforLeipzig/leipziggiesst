    ...
    <StyledTop>
      <Wrapper>
        ...
        {!isMobile && (<div style={{ width: '60%', fontSize: '16pt', fontStyle: 'bold', color: 'blue' }}>
          ...
          <b>Kommender Termin:</b><del>Samstag, den 24. August, ab 16:30 Uhr</del> - <div style={{ color: 'red', fontStyle: 'bold' }}>ACHTUNG: wegen Hitze vorschoben auf Mitte/Ende September</div>: Pumpen, Gießen und Singen als Teil unserer <a style={{ cursor: 'pointer', textDecoration: 'underline' }} onClick={() => { history.push("/event/20240824_radeln_pumpen_giessen_singen")}}>Handschwengelpumpenradtour</a>.
        </div>)}
      </Wrapper>
